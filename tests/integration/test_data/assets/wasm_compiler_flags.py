...
fastled_lib_path = get_fastled_library_path_test(build_mode_lower)

# Note: Library linking is handled by platformio.ini, not here (test version)
print(f"Test build will use FastLED library: {fastled_lib_path}")
